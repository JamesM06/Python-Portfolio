...
def dru_tower():
    msg = f"We are the -Tower of the Arch Druids- ans I am Ielsa Druids of roses.\n"
    for character in msg:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(0.04) 
    msg = f"We have been for told of your arival{myPlayer.name}\nWhat is it that you seek?"
    for character in msg:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(0.04)     
    print("\nMe: I seek the key, The key of the obalisk. (1)")
    while True:
        ans = input("> ")
        if ans == "1":
            break
            ...
            print("Error wrong input") 
    msg = f"Ielsa: Thats where your knolage stops, and mine continues...\n"
    for character in msg:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(0.04)     
    ...
    for character in msg:
        ...
        time.sleep(0.1)     
    time.sleep(2)
    msg = f"Its a offering of sorts...\n"
    for character in msg:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(0.15)
    print("Me: Like gold or silks?(1)")
    while True:
        ans = input("> ")
        if ans == "1":
            break
            ...
            print("Error wrong input") 
    msg = f"Ielsa: No... Like a token. we beleave its located in 'c' (a clearing with a Sacred Stone Circle)\n"
    for character in msg:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(0.17)
    msg = f"Ielsa: now i must return to my studies. Good bye "+myPlayer.name+"\n"
    for character in msg:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(0.17)
